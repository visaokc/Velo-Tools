...
#
# Preferred path uses `git archive` so the zip is exactly the tracked source at the
# given ref (gitignored files such as __pycache__ are excluded automatically) with a
# top-level velo_tools/ folder (installable by Blender and by a future updater).
