...
class VTEF_MergeVertexGroups(bpy.types.Operator):
    bl_idname = "vtef.merge_vertex_groups"
...
class VTEF_FillGapsInVertexGroups(bpy.types.Operator):
    """
    ...
    """
    bl_idname = "vtef.fill_gaps_in_vertex_groups"
...
class VTEF_RemoveUnusedVertexGroups(bpy.types.Operator):
    """
    Remove all vertex groups from selected objects
    """
    bl_idname = "vtef.remove_unused_vertex_groups"
...
class VTEF_RemoveAllVertexGroups(bpy.types.Operator):
    """
    Remove all vertex groups from selected objects
    """
    bl_idname = "vtef.remove_all_vertex_groups"
...
class VTEF_ApplyModifierForObjectWithShapeKeysOperator(bpy.types.Operator):
    bl_idname = "vtef.apply_modifier_for_object_with_shape_keys"
...
class VTEF_CreateMergedObject(bpy.types.Operator):
    bl_idname = "vtef.create_merged_object"
...
class VTEF_ApplyMergedObjectSculpt(bpy.types.Operator):
    bl_idname = "vtef.apply_merged_object_sculpt"
...
class VTEF_ApplyMergedObjectSculptWithShapekeys(bpy.types.Operator):
    bl_idname = "vtef.apply_merged_object_sculpt_with_shapekeys"
...
class VTEF_ConvertVertexColors(bpy.types.Operator):
    bl_idname = "vtef.convert_vertex_colors"
...
class VTEF_FillMissingMeshData(bpy.types.Operator):
    bl_idname = "vtef.fill_missing_mesh_data"
