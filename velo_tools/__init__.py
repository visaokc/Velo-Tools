...
_modules = (updater, properties, operators, ui, bone_number_map, overlay, general_mapping, mesh, weights, games, _core_mapping, _core_export, _mapping_positions, _mesh_references)
